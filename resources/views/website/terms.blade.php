					...
					<div class="container">
						<div class="row">
							<div class="col-12 col-sm-8 col-md-6">
								<h1 class="main_heading">Terms of Use</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="section bc1-lightester-bg">
				<div class="container">
					<article class="article">
						<h2 class="basecolor3">Introduction</h2>
						...
						<h2 class="basecolor3">Representations and Warranties</h2>
						...
						<h2 class="basecolor3">Access &amp; Profile</h2>
						...
						<h2 class="basecolor3">License(s) Granted by JoeyCo</h2>
						...
						<h2 class="basecolor3">License(s) Granted by User</h2>
						...
						<h2 class="basecolor3">Covenants of User</h2>
						...
						<h2 class="basecolor3">Payment Terms</h2>
						...
						<h2 class="basecolor3">Third Party Interactions</h2>
						...
						<h2 class="basecolor3">Acknowledgements</h2>
						...
						<h2 class="basecolor3">Reviews</h2>
						...
						<h2 class="basecolor3">Export Control</h2>
						...
						<h2 class="basecolor3">General</h2>
