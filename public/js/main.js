$(function () {
                            ...
                            selectedForm.append(`
                                <div class="form_message flexbox flex-center jc-center">
                                    <div class="form_message_inner align-center">
                                        ...
                                        <p>We've received your request, our joey will be in touch with you soon.</p>
    ...
    var PAGE_CAREER = {
        tabChange: function(){
            var city = $('#careerCityTabs .nav-item .nav-link').html();
            $('input[name="city"]').attr('value', city);
        },
        init: function() {
            $('[data-target="#applyNow"]').on('click', function(){
                var jobTitle = $(this).closest('.card').find('.card-header .btn-link').html();
                $('input[name="job_title"]').attr('value', jobTitle.trim());
            });

            $('#applyNow').on('show.bs.modal', function () {
                PAGE_CAREER.tabChange();
            });
        }
    }
    // ---------------------PAGE CAREER - [/end]
